...
- [jevMail](https://github.com/ilyamk/jev-gmail-ai-spam-filter-and-labeling) - Unofficial Google Apps Script Gmail organizer: Jev `Choice` maps each email to a user-defined label, then confidence gates full-content review and optional archiving
