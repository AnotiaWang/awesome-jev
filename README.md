...
- [slop-grader](https://github.com/lukstei/slop-grader) - Rule-based CLI and agent skill that grades text for AI slop, grammar, and technical documentation quality, and guides an AI agent to auto-fix violations
